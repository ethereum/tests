...
// If we start from opcode zero, test all opcodes. Otherwise,
// just test that specific opcode
const opcodeNum = fromOpcode == 0 ? 0x100 : 1
...
testOpcodes:
  ...
  env:
    ...
    previousHash: a2a9e765aff8e8908d47b54e9ef7d24d14be5291ada9444a2e3104a53e0d6057
...
`
  ...
  for(var i=fromOpcode; i<fromOpcode+opcodeNum; i++)
    retVal += `
          [[${i}]] (call 10000000 ${opcode2Addr(i)} 0 0 32 0 0)`
